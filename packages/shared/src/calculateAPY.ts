import { stakers, Staker, TenderizerDaysType } from "@tender/shared/src/index";
import { ProtocolName } from "./data/stakers";

export const calculateAPY = (data: TenderizerDaysType | undefined): Record<Staker["name"], Staker> => {
